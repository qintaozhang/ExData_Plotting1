...
plot(plot_data_clean$Global_active_power~plot_data_clean$Datetime, ylab="Global Active Power)",col="black", xlab="", type="l")
...
plot(plot_data_clean$Voltage~plot_data_clean$Datetime, ylab="Voltage",col="black", xlab="datetime", type="l")

plot(plot_data_clean$Global_reactive_power~plot_data_clean$Datetime, ylab="Global_reactive_power",col="black", xlab="datetime", type="l")
